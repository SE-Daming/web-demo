    ...
    <el-dialog title="详细订单信息" :visible.sync="dialogVisible" width="40%" :close-on-click-modal="false">
      <el-form ref="orderForm" :model="currentOrder" label-width="100px">
        <el-form-item label="家电产品类型">
          <el-input v-model="currentOrder.productType" :disabled="true"
        ...
        <el-form-item label="维修开始时间">
          <el-date-picker v-model="currentOrder.repairTime" type="datetime" :disabled="true"
                          style="width: 100%; min-width: 200px;"></el-date-picker>
        </el-form-item>
        <el-form-item label="预计维修时间">
          <el-input v-model="currentOrder.repairDuration" :disabled="true"
                    style="width: 100%; min-width: 200px;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="订单创建时间">
          <el-date-picker v-model="currentOrder.createdAt" type="datetime" :disabled="true"
                          style="width: 100%; min-width: 200px;"></el-date-picker>
        </el-form-item>
